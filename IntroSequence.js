...
const scenes = {
    ...
    leo_schedule: {
        text: 'Leo works 16 hours a day, 6 days a week. He has 2 hours of sleep. He claims his smile never wavers because "life is beautiful!" He maintains this smile throughout his testimony.\n\n',
        options: [
    ...
    dev_mood: {
        text: 'Dev is ALWAYS in a good mood. He was in a good mood the day of the murder. He\'s in a good mood right now, despite being interrogated for murder. He finds this inconsistency between his mood and the tragedy "philosophically confusing."\n\n',
        options: [
            { text: 'Back to Dev', nextScene: 'dev' },
            { text: 'Back to interrogation room', nextScene: 'intro' }
        ]
